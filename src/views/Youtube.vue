            ...
            <form @submit.prevent="SearchMovies()">
              ...
              <div class="youtube">
                <div v-for="movie in movies" :key="movie.id.videoId">
                  <a
                    :href="'http://www.youtube.com/embed/' + movie.id.videoId"
                    target="_blank"
                  >
                    <img
...
export default {
  ...
  setup() {
    ...
    const SearchMovies = () => {
      if (search.value != "") {
        fetch(
          `https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=28&q=${search.value}&type=video&key=AIzaSyCkkBLtJYpoYRaEuxnnprnR1bBBbhrSMz0&type=video`
        )
